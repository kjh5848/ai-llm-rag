...
def generate_image_markdown(image_path, output_md, model="llava"):
    ...
    try:
        ...
        # 이미지 파일의 상대 경로 계산 (Markdown 내에서 이미지를 올바르게 참조하기 위함)
        rel_image_path = os.path.relpath(image_path, os.path.dirname(output_md))
...
if __name__ == "__main__":
    sample_image = "data/docs/ops/OPS_매출현황_v1.0.png"
